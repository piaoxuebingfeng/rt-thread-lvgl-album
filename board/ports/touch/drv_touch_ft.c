...
{
    /* TouchScreen FT6206 Slave I2C address is 0x54   0101 0100 <<1 =   1010 1000   0xA8
     * 0x54 << 1 = 0x2A                               0101 0100 >>1 =   0010 1010   0x2A
     */
	
	
	
		/*
	   *	FT6336G   slave i2c address is 0x70      0111 0000  << 1  =  1110 0000  = 0xe0
	   *                                           0111 0000  >> 1  =  0011 1000  = 0x38
		*/
    ft_driver.address = 0x38;
//		ft_driver.address = 0xA8;
//		ft_driver.address = 0x70;
