...
static void lv_calendar_constructor(const lv_obj_class_t * class_p, lv_obj_t * obj)
{
    ...
    lv_style_set_radius(&style_btn, lv_pct(100)/2);
    lv_style_set_bg_color(&style_btn,lv_palette_main(LV_PALETTE_LIGHT_BLUE));
    ...
    lv_obj_add_style(calendar->btnm, &style_btn, LV_PART_ITEMS);
